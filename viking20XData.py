...
ds = xr.open_dataset("1_VIKING20X.L46-KFS003_1m_19580101_19581231_vosaline_45W_80W_30N_57N_upper1000m.nc")
...
##temp_ave = temp_ave['votemper'].sel(deptht = 60, method = 'nearest')
...
decade_trend_map = ax1.pcolormesh(yearly_alldepths_bottom.nav_lon, yearly_alldepths_bottom.nav_lat, yearly_alldepths_bottom, vmin=28,vmax=35, cmap = plt.get_cmap('cmo.haline'))

#plotting the color bar
fig.colorbar(decade_trend_map, orientation='vertical', label='Bottom Salinity Trend ($^\circ$C/decade)', shrink = 0.4)

GeorgesBank = ax1.plot([-67.805333], [40.727667],
         color='black', marker='o', markeredgecolor = 'yellow', markeredgewidth = 2, markersize = 12,linestyle = 'None',zorder = 103
         )
