...
from longIslandAnnualAnomalies import sodaAnnualAnoms
from longIslandExpertAnomalies import sodaExpertAnoms
...
figname = "longIsland_SODA_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
