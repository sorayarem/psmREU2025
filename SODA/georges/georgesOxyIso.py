...
def calcOxyIsoAnoms(d18ORaw):
  ...
  ## computing avg d18O
  d18OAvg = d18ORaw["georgesIso"].mean()     
  ## computing the anomalies 
  d18ORaw["d18OAnoms"] = d18ORaw["georgesIso"] - d18OAvg
  return d18ORaw[["year", "d18OAnoms"]]

def processFile(d18ORaw):
  ## loading the data
  d18ORaw = pd.read_csv(d18ORaw)
  return d18ORaw[["year", "georgesIso"]]

## storing the result of the function
d18OAnoms = calcOxyIsoAnoms("./d18O_data/georgesBank")
d18OData = processFile("./d18O_data/georgesBank")