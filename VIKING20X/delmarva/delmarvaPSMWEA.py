...
from delmarvaAnnualAnomalies import vikingAnnualAnoms
from delmarvaExpertAnomalies import vikingExpertAnoms
...
figname = "delmarva_VIKING20X_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
