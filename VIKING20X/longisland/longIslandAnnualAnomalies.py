...
def calcSodaAnoms(vikingTEMPFile, vikingSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(deptht = 48, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['y', 'x'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(deptht = 48, method = 'nearest')
...
vikingAnnualAnoms = calcSodaAnoms("./VIKING20X/selections/tempLONGISLAND.nc", "./VIKING20X/selections/saltLONGISLAND.nc")