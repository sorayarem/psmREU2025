...
from jonesportAnnualAnomalies import vikingAnnualAnoms
from jonesportExpertAnomalies import vikingExpertAnoms
...
figname = "jonesport_VIKING20X_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
