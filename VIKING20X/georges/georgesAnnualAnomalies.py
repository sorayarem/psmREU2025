...
def calcSodaAnoms(vikingTEMPFile, vikingSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(deptht = 72, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['y', 'x'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(deptht = 72, method = 'nearest')
...
vikingAnnualAnoms = calcSodaAnoms("./VIKING20X/selections/tempGEORGES.nc", "./VIKING20X/selections/saltGEORGES.nc")