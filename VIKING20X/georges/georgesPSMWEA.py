...
from georgesAnnualAnomalies import vikingAnnualAnoms
from georgesExpertAnomalies import vikingExpertAnoms
...
figname = "georges_VIKING20X_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
