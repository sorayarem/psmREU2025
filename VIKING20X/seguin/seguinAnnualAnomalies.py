...
def calcSodaAnoms(vikingTEMPFile, vikingSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(deptht = 38, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['y', 'x'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(deptht = 38, method = 'nearest')
...
vikingAnnualAnoms = calcSodaAnoms("./VIKING20X/selections/tempSEGUIN.nc", "./VIKING20X/selections/saltSEGUIN.nc")