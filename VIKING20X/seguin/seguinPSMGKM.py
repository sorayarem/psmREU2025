...
parser.add_argument('--season', type=int, choices=[0, 1], default=1, help='Seasonal preference (0 = Annual, 1 = Expert)')
...
figname = "seguin_VIKING20X_GKM_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
