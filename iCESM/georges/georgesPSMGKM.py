...
dsIso = xr.open_dataset("./iCESM/selections/isoGEORGES.nc")
...
d18OFiltered = d18OFiltered.drop_duplicates(subset='year')
...
if isotope:
    figname = "georges_iCESM_GKM_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "georges_iCESM_GKM_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
