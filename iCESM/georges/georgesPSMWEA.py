...
from georgesAnnualAnomalies import iCESMAnnualAnoms
from georgesExpertAnomalies import iCESMExpertAnoms
...
if isotope:
    figname = "georges_iCESM_WEA_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "georges_iCESM_WEA_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
