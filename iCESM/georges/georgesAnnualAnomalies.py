...
def calcSodaAnoms(iCESMTEMPFile, iCESMSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(z_t = 72, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['nlat', 'nlon'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(z_t = 72, method = 'nearest')
...
iCESMAnnualAnoms = calcSodaAnoms("./iCESM/selections/tempGEORGES.nc", "./iCESM/selections/saltGEORGES.nc")