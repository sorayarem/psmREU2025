...
dsIso = xr.open_dataset("./iCESM/selections/isoJONESPORT.nc")
...
if isotope:
    figname = "jonesport_iCESM_GKM_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "jonesport_iCESM_GKM_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
