...
def calcSodaAnoms(iCESMTEMPFile, iCESMSALINEFile):
    ...
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(z_t = 80, method = 'nearest')
...
iCESMAnnualAnoms = calcSodaAnoms("./iCESM/selections/tempJONESPORT.nc", "./iCESM/selections/saltJONESPORT.nc")