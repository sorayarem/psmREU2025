...
def calcSodaAnoms(iCESMTEMPFile, iCESMSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(z_t = 31, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['nlat', 'nlon'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(z_t = 31, method = 'nearest')
...
iCESMAnnualAnoms = calcSodaAnoms("./iCESM/selections/tempISLEAUHAUT.nc", "./iCESM/selections/saltISLEAUHAUT.nc")