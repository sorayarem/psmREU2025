...
spatialMeanAnomsTemp_0 = dsTemp.mean(dim=['nlat', 'nlon'])
spatialMeanAnomsTemp_0 = spatialMeanAnomsTemp_0.sel(z_t = 0, method = 'nearest')
spatialMeanAnomsSaline_0 = dsSaline.mean(dim=['nlat', 'nlon'])
spatialMeanAnomsSaline_0 = spatialMeanAnomsSaline_0.sel(z_t = 0, method = 'nearest')
...
temps_0 = annualTempAnoms_0['TEMP'].values
salts_0 = annualSalineAnoms_0['SALT'].values

## averaging over space and selecting a specific depth
spatialMeanAnomsTemp_30 = dsTemp.mean(dim=['nlat', 'nlon'])
spatialMeanAnomsTemp_30 = spatialMeanAnomsTemp_30.sel(z_t = 3000, method = 'nearest')
spatialMeanAnomsSaline_30 = dsSaline.mean(dim=['nlat', 'nlon'])
spatialMeanAnomsSaline_30 = spatialMeanAnomsSaline_30.sel(z_t = 3000, method = 'nearest')
...
temps_30 = annualTempAnoms_30['TEMP'].values
salts_30 = annualSalineAnoms_30['SALT'].values

## averaging over space and selecting a specific depth
spatialMeanAnomsTemp_50 = dsTemp.mean(dim=['nlat', 'nlon'])
spatialMeanAnomsTemp_50 = spatialMeanAnomsTemp_50.sel(z_t = 5000, method = 'nearest')
spatialMeanAnomsSaline_50 = dsSaline.mean(dim=['nlat', 'nlon'])
spatialMeanAnomsSaline_50 = spatialMeanAnomsSaline_50.sel(z_t = 5000, method = 'nearest')
...
temps_50 = annualTempAnoms_50['TEMP'].values
salts_50 = annualSalineAnoms_50['SALT'].values
...
temps_80 = annualTempAnoms_80['TEMP'].values
salts_80 = annualSalineAnoms_80['SALT'].values
