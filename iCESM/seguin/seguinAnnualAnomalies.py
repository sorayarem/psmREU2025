...
def calcSodaAnoms(iCESMTEMPFile, iCESMSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(z_t = 38, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['nlat', 'nlon'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(z_t = 38, method = 'nearest')
...
iCESMAnnualAnoms = calcSodaAnoms("./iCESM/selections/tempSEGUIN.nc", "./iCESM/selections/saltSEGUIN.nc")