...
dsIso = xr.open_dataset("./iCESM/selections/isoSEGUIN.nc")
...
if isotope:
    figname = "seguin_iCESM_GKM_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "seguin_iCESM_GKM_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
