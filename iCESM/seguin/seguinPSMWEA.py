...
from seguinAnnualAnomalies import iCESMAnnualAnoms
from seguinExpertAnomalies import iCESMExpertAnoms
...
if isotope:
    figname = "seguin_iCESM_WEA_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "seguin_iCESM_WEA_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
