...
def calcOxyIsoAnoms(d18ORaw):
  ...
  ## computing avg d18O
  d18OAvg = d18ORaw["longIslandIso"].mean()     
  ## computing the anomalies 
  d18ORaw["d18OAnoms"] = d18ORaw["longIslandIso"] - d18OAvg
  return d18ORaw[["year", "d18OAnoms"]]

def processFile(d18ORaw):
  ## loading the data
  d18ORaw = pd.read_csv(d18ORaw)
  return d18ORaw[["year", "longIslandIso"]]

## storing the result of the function
d18OAnoms = calcOxyIsoAnoms("./d18O_data/longIsland")
d18OData = processFile("./d18O_data/longIsland")