...
dsIso = xr.open_dataset("./iCESM/selections/isoLONGISLAND.nc")
...
if isotope:
    figname = "longIsland_iCESM_GKM_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "longIsland_iCESM_GKM_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
