...
dsIso = xr.open_dataset("./iCESM/selections/isoDELMARVA.nc")
...
if isotope:
    figname = "delmarva_iCESM_GKM_M" + str(model) + "(I)_" + ("EXP" if season else "ANN") + ".png"
else:
    figname = "delmarva_iCESM_GKM_M" + str(model) + "(S)_" + ("EXP" if season else "ANN") + ".png"
