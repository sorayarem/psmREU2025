...
def calcSodaAnoms(glorysTEMPFile, glorysSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(depth = 38, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['latitude', 'longitude'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(depth = 38, method = 'nearest')
...
glorysExpertAnoms = calcSodaAnoms("./GLORYS/selections/tempSEGUIN.nc", "./GLORYS/selections/saltSEGUIN.nc")