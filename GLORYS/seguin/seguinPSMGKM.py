...
## loading in the data
dsTemp = xr.open_dataset("./GLORYS/selections/tempSEGUIN.nc")
dsSaline = xr.open_dataset("./GLORYS/selections/saltSEGUIN.nc")
...
spatialMeanTemp = spatialMeanTemp.sel(depth = 38, method = 'nearest')
spatialMeanSaline = dsSaline.mean(dim=['latitude', 'longitude'])
spatialMeanSaline = spatialMeanSaline.sel(depth = 38, method = 'nearest')
...
figname = "seguin_GLORYS_GKM_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
