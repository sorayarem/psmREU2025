...
from seguinAnnualAnomalies import glorysAnnualAnoms
from seguinExpertAnomalies import glorysExpertAnoms
...
figname = "seguin_GLORYS_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
