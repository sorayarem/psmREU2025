...
from georgesAnnualAnomalies import glorysAnnualAnoms
from georgesExpertAnomalies import glorysExpertAnoms
...
figname = "georges_GLORYS_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
