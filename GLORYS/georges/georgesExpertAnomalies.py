...
def calcSodaAnoms(glorysTEMPFile, glorysSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(depth = 72, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['latitude', 'longitude'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(depth = 72, method = 'nearest')
...
glorysExpertAnoms = calcSodaAnoms("./GLORYS/selections/tempGEORGES.nc", "./GLORYS/selections/saltGEORGES.nc")