...
## loading in the data
dsTemp = xr.open_dataset("./GLORYS/selections/tempGEORGES.nc")
dsSaline = xr.open_dataset("./GLORYS/selections/saltGEORGES.nc")
...
spatialMeanTemp = spatialMeanTemp.sel(depth = 72, method = 'nearest')
spatialMeanSaline = dsSaline.mean(dim=['latitude', 'longitude'])
spatialMeanSaline = spatialMeanSaline.sel(depth = 72, method = 'nearest')
...
figname = "georges_GLORYS_GKM_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
