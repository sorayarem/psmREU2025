...
from delmarvaAnnualAnomalies import glorysAnnualAnoms
from delmarvaExpertAnomalies import glorysExpertAnoms
...
figname = "delmarva_GLORYS_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
