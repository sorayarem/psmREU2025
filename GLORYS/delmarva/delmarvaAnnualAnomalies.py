...
def calcSodaAnoms(glorysTEMPFile, glorysSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(depth = 63, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['latitude', 'longitude'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(depth = 63, method = 'nearest')
...
glorysAnnualAnoms = calcSodaAnoms("./GLORYS/selections/tempDELMARVA.nc", "./GLORYS/selections/saltDELMARVA.nc")