...
def calcSodaAnoms(glorysTEMPFile, glorysSALINEFile):
    ...
    spatialMeanAnomsTemp = spatialMeanAnomsTemp.sel(depth = 31, method = 'nearest')
    spatialMeanAnomsSaline = saltAnomalies.mean(dim=['latitude', 'longitude'])
    spatialMeanAnomsSaline = spatialMeanAnomsSaline.sel(depth = 31, method = 'nearest')
...
glorysAnnualAnoms = calcSodaAnoms("./GLORYS/selections/tempISLEAUHAUT.nc", "./GLORYS/selections/saltISLEAUHAUT.nc")