...
## loading in the data
dsTemp = xr.open_dataset("./GLORYS/selections/tempISLEAUHAUT.nc")
dsSaline = xr.open_dataset("./GLORYS/selections/saltISLEAUHAUT.nc")
...
spatialMeanTemp = spatialMeanTemp.sel(depth = 31, method = 'nearest')
spatialMeanSaline = dsSaline.mean(dim=['latitude', 'longitude'])
spatialMeanSaline = spatialMeanSaline.sel(depth = 31, method = 'nearest')
...
figname = "isle_GLORYS_GKM_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
