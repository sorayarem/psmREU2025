...
spatialMeanTemp = spatialMeanTemp.sel(depth = 48, method = 'nearest')
spatialMeanSaline = dsSaline.mean(dim=['latitude', 'longitude'])
spatialMeanSaline = spatialMeanSaline.sel(depth = 48, method = 'nearest')
...
figname = "longIsland_GLORYS_GKM_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
