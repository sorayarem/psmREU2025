...
from longIslandAnnualAnomalies import glorysAnnualAnoms
from longIslandExpertAnomalies import glorysExpertAnoms
...
figname = "longIsland_GLORYS_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
