...
## loading in the data
dsTemp = xr.open_dataset("./GLORYS/selections/tempJONESPORT.nc")
dsSaline = xr.open_dataset("./GLORYS/selections/saltJONESPORT.nc")
...
spatialMeanTemp = spatialMeanTemp.sel(depth = 80, method = 'nearest')
spatialMeanSaline = dsSaline.mean(dim=['latitude', 'longitude'])
spatialMeanSaline = spatialMeanSaline.sel(depth = 80, method = 'nearest')
...
figname = "jonesport_GLORYS_GKM_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
