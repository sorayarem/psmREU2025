...
from jonesportAnnualAnomalies import glorysAnnualAnoms
from jonesportExpertAnomalies import glorysExpertAnoms
...
figname = "jonesport_GLORYS_WEA_M" + str(model) + "_" + ("EXP" if season else "ANN") + ".png"
